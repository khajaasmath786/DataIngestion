...
class CaseWhenOtherWise:
    ...
    def run_pipeline(self):
        try:
            ...
            filePath = str(get_project_root())+"/resources/data/small_zipcode.csv"
            ...
            logging.info("Asmath --> Easy usage is to follow the json format while replacing values , second way is reverse value and then key")
